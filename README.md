...
Coastal Guitar Tuition is a business based in North Wales in the coastal town of Prestatyn. The primary business goal is to provide guitar lessons to the local community to students of all ages and abilities. The business also provides guitar setup and maintenance. The business also has a state of the art recording studio which is open not only to students of Coastal Guitars, but to the wider community as well.
...
* Users wanting to use the studio practice or record music.
...
* To have social media links in the footer of each page. This enables the user to follow Coastal Guitars via the various social networks and be up to date with the latest information. It also gives users multiple platforms in which to contact Coastal Guitar Tuition.
...
The main colours used throughout the site are surf green and white as these are the colour of the company’s logo. White text against the green background provides a good contract and allows the text to be easily read. The business is also very close to the beech front and the colour choices have been chosen to reflect this theme.

## Typography

The Roboto font is the main font used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly from google fonts. Roboto a clean, friendly font often used in web development, meaning it is aesthetically pleasing and suitable choice for this site.
...
* The company logo is also a link to the home page on every page.
...
* The footer is very minimalistic. The footer has links to the four main social networks, Facebook, Instagram, YouTube and Twitter. It uses their logos rather than their names with are univerally instantaly recognisable.
* The icons are in the same green #00A3A3 colour as as the rest of the website to keep it uniform with the companys branding further enhancing the company's colours and identity.
...
* This image was picked for several reasons. Firstly the guitar is a Fender Stratocaster, the most famous and recognisable guitar on the planet. Most people, even if they dont know the make and model of the guitar, they know it is a guitar and will have seen it in many films and TV programmes. Scondly the image clearly links to what the site is trying to promote and offer, this being guitar lessons. Thirdly, the colour of the guitar is that of the the company colours. The image is also a road worn guitar, its not shiny and new and shows a guitar that has had many hours of playing and enjoyment.
...
* The paragpraphs are short and quickly introduce what the company is offering. It informs the user that their first lesson is free and that everyone is welcome to study at Coastal Guitars. Having the first lesson free is trying to show the user we are passionate about guitar teaching and not merely motivated by money, but for the love and passion for the instrument.
...
* [Bytes](https://ui.dev/amiresponsive) - to see the site on different devices with a screenshot used in the README.
...
* Each page was tested through the lighthouse tool. The results are detailed below:
...
Overall performance evaluated by lighthouse is very good and everything is within the green range. There was initially and issue with the index page returning a performance value of 72. Lighthouse indicated it was an issue with Font Awesome icons which were on the headings 'First Lesson Free' and 'Everyone Welcome'. I immediately decided to remove these as the icons added nothing extra that the pictures above didn't already portray. Immediately upon removing them and re-running through lighthouse the perfomance increased to 92% which is a good acceptable figure.
...
* As soon as you land on the index page you are greeted with the words 'Welcome To Coastal Guitar Tuition'. There is zero ambiguity in this welcome statement and what you are being welcomed to. The company logo is also in to top left hand corner which also states the company name. Scrolling down the home page, the last section 'What We Have To Offer', is clear and concise as to the services being provided.
...
* Navigation throught the site, whether on mobile or desktop/laptop is straight forward. The utilisation of a bootstrap navbar allows this to happen with ease. Links are easy to see, are clearly labelled and every page is uniform in relation to the navigation links in the navbar.
...
* Links to all social media accounts are in the footer of every page. Users can reach out on any of the social media platforms. Alternatively the phone number and address are provided on the studio page and users are invited to call or visit the studio.
